...
| **Lab 3** | [03-lab3-export-to-lakehouse-slides.md](./03-lab3-export-to-lakehouse-slides.md) | Export graph data back to Delta tables |
| **Lab 4** | [04-lab4-ai-agents-slides.md](./04-lab4-ai-agents-slides.md) | Create Genie and Knowledge Agents |
| **Lab 5** | [05-lab5-multi-agent-slides.md](./05-lab5-multi-agent-slides.md) | Build Multi-Agent Supervisor system |
| **Lab 6** | [06-lab6-augmentation-agent-slides.md](./06-lab6-augmentation-agent-slides.md) | AI-driven graph augmentation analysis |
...
Lab 2: Neo4j Import (Spark Connector)
       ↓
Lab 3: Export to Lakehouse
       ↓
Lab 4: Create AI Agents (Genie + Knowledge)
       ↓
Lab 5: Multi-Agent Supervisor
       ↓
Lab 6: Graph Augmentation Analysis
```
